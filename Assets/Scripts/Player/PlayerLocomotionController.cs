...
public class PlayerLocomotionController : MonoBehaviour, ICharacterController
{
    ...
    /// <summary>
    /// This is called every frame by PlayerManager in order to tell the character what its inputs are.
    /// </summary>
